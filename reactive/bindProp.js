  ...
  export const bindPropToTemplate = function(template, id, prop, componentId) {
    console.log("bindPropToTemplate:" + id + ":" + this[prop])
    Dep.target = new Watcher('Binding prop Watcher: ' + id, this.render, this, template, id, componentId)
